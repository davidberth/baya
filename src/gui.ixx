...
export void init_gui(float scale_factor)
{
	imguiCreate(scale_factor);
...
export void render_gui(int mx, int my, int button_state, int width, int height)
{
